...
const mintInfoAddress = "0x1Ac17FFB8456525BfF46870bba7Ed8772ba063a5";
...
async function generateAfterReveal() {
    const provider = new JsonRpcProvider(`https://optimism-mainnet.infura.io/v3/${process.env.REACT_APP_INFURA_KEY}`);
    ...
    for (let i = ids.length - 1; i >= 0; i--) {
        ...
        try {
            ...
            let standardMetadata = {
                ...
                "description": "",
                "image": result.link,
                "external_url": `https://dbxen.org/your-dbxenfts/${METADATA_BUCKET_OP}/${ids[i]}`,
