...
cron.schedule('*/1 * * * *', async() => {
    const provider = new AnkrProvider('https://rpc.ankr.com/multichain/176615b8980e76f8171a64a07f901edfa45fc60a3200f6921bcb6f774056ecc7');
    ...
    const logs = async() => {
        return await provider.getLogs({
            ...
            fromBlock: 39565964,
            toBlock: 39860656,
            topics: ["0x351a36c9c7d284a243725ea280c7ca2b2b1b02bf301dd57d03cbc43956164e78"]
        });
    };
    logs().then((reply) => {
        console.log("First log:")
        console.log();
        console.log(reply.logs[0])
        console.log("Data for decode:")
        console.log();
        console.log(reply.logs[0].data)
        console.log("Data decoded:")
        console.log();
        console.log(web3.eth.abi.decodeParameters(typesArray, reply.logs[0].data))
    })
});