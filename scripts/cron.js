...
async function getLast24HoursIdsMinted() {
    ...
    let dateForParam = subMinutes(new Date(), 9000);
    let results = [];
...
function getImage(power, counter1, counter2, counter3, counter4, counter5, counter6, counter7, counter8, counter9) {
    ...
    if (power > 10000 && power <= 12500)
        return { link: `https://dbxen-be.prodigy-it-solutions.com/api/assets/deboxnft-assets-10001-12500/[10001-12500]_DBXENFT_${counter7}.png`, value: 7 }
