...
export function Stake(props: any): any {
    ...
    const dateOP: any = new Date(Date.UTC(2023, 12, 17, 14, 0, 23, 0));
    const datePLS : any = new Date(Date.UTC(2023, 12, 17, 13, 9, 45, 0));
        ...
        return (
            <>
                <Card variant="outlined" className="card-container buy-and-burn-container">
                    ...
                    <CardActions className='button-container px-3'>
                        <LoadingButton className="collect-btn" loading={loading} variant="contained" onClick={() => {}}>
                            Buy & Burn & Earn
                        </LoadingButton>
                    </CardActions>
                </Card>
