...
export function Stake(props: any): any {
    ...
    const dateEthereum: any = new Date(Date.UTC(2030, 12, 22, 14, 0, 11, 0));
    const datePolygon: any = new Date(Date.UTC(2030, 12, 17, 14, 3, 19, 0));
    const dateAvalanche: any = new Date(Date.UTC(2030, 12, 17, 14, 7, 20, 0));
    const dateBinance: any = new Date(Date.UTC(2030, 12, 17, 13, 57, 40, 0));
    const dateOKXChain: any = new Date(Date.UTC(2030, 12, 17, 11, 24, 7, 0));
    const dateFantom: any = new Date(Date.UTC(2030, 12, 17, 11, 44, 7, 0));
    const dateDogechain: any = new Date(Date.UTC(2030, 12, 17, 11, 55, 14, 0));
    const dateMoonbeam: any = new Date(Date.UTC(2030, 12, 17, 12, 3, 30, 0));
    const dateEvmos: any = new Date(Date.UTC(2030, 12, 17, 12, 16, 48, 0));
    const dateEthereumPow: any = new Date(Date.UTC(2030, 12, 17, 12, 24, 59, 0));
    const dateBase: any = new Date(Date.UTC(2030, 12, 17, 19, 0, 43, 0));
    const dateOP: any = new Date(Date.UTC(2030, 12, 17, 14, 0, 23, 0));
    const datePLS : any = new Date(Date.UTC(2030, 12, 17, 13, 9, 45, 0));
