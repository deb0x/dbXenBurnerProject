...
describe("Test claim fee functionality", async function() {
    ...
    it.only("Claim fees", async() => {
        ...
        console.log("fees")
        console.log(ethers.utils.formatEther(unclaimedFeesAlice.toString()))
        console.log();
        console.log("BOB");
        console.log();
        await hre.ethers.provider.send("evm_increaseTime", [60 * 60 * 24])
        ...
        console.log("BOB FEE")
        console.log(ethers.utils.formatEther(unclaimedFeesBob.toString()))
    });
